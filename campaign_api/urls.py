...
from .views import campaign_list, campaign_detail, category_list, category_detail, city_list, city_detail, CampaignDetail, CampaignList, login_view, signup_view, logout_view, check_auth
